...
engineVisistatore = create_engine('postgres+psycopg2://visitatoree:0000@localhost:5432/CinemaBasi')
...
@login_required
def acquista():
    eng = create_engine('postgresql+psycopg2://clienteloggato:1234@localhost:5432/CinemaBasi',
